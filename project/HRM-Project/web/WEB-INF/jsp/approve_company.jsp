                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        <%
                                            ...
                                            String sql = "select company_reg.*,login_tbl.Status from company_reg inner join login_tbl where login_tbl.Status=0";
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" onclick="approveRejectCompany(1,'<%= rs.getString("UserName")%>')">Approve</a>||<a href="#" onclick="approveRejectCompany(1,'<%= rs.getString("UserName")%>')">Reject</a></td>
                                        </tr>
                                        <%
                                            }
                                        %>
